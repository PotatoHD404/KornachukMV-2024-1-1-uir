...
\usepackage[singlelinecheck=false,font=onehalfspacing,labelsep=endash]{caption}
\DeclareCaptionLabelSeparator{endash}{~--- }
\captionsetup[table]{justification=raggedright,position=top}
\captionsetup[figure]{justification=raggedright,name=Рисунок,position=bottom}

\usepackage{titlesec}
\titleformat{\chapter}[block]{\normalfont\large\bfseries\filcenter}{\thechapter.}{1ex}{}
\titlespacing*{\chapter}{0pt}{0pt}{14pt}
\titleformat{\section}[block]{\normalfont\fontsize{13}{15}\selectfont\bfseries}{\thesection}{1ex}{}
\titlespacing*{\section}{0pt}{12pt}{0pt}
\titleformat{\subsection}[block]{\normalfont\fontsize{12}{15}\selectfont\bfseries}{\thesubsection}{1ex}{}
...
\newcounter{totalcitations}
\setcounter{totalcitations}{0}
\AtEveryBibitem{\stepcounter{totalcitations}}

% \newcommand{\newappendix}{%
 
%   \section*{Приложение \Alph{totalappendices}}%
% }
% \renewcommand{\appendix} {
%   \stepcounter{totalappendices}
%   \theappendix
% }
% \gdef\theappendix{\ifnum\c@appendix=1 А\else\ifnum\c@appendix=2 Б\else\ifnum\c@appendix=3 В\else\ifnum\c@appendix=4 Г\else\ifnum\c@appendix=5 Д\else\ifnum\c@appendix=6 Е\else\ifnum\c@appendix=7 Ж\else\@Alph\c@appendix\fi\fi\fi\fi\fi\fi\fi}
% \makeatletter
% \renewcommand{\theappendix}{%
%   \stepcounter{totalappendices}%
%   \ifcase\c@appendix\or А\or Б\or В\or Г\or Д\or Е\or Ж\or З\or И\or К\or Л\or М\or Н\or О\else\@Alph\c@appendix\fi}
% \makeatother
